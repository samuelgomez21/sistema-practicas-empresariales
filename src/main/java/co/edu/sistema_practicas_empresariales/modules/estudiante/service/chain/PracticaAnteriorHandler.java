...
import co.edu.sistema_practicas_empresariales.modules.estudiante.service.strategy.PracticaAnteriorStrategy;
...
public class PracticaAnteriorHandler extends ValidadorAptitudHandler {
    private final RequisitoValidationStrategy strategy = new PracticaAnteriorStrategy();
