...
import co.edu.sistema_practicas_empresariales.modules.estudiante.service.strategy.PromedioMinimoStrategy;
...
public class PromedioHandler extends ValidadorAptitudHandler {
    private final RequisitoValidationStrategy strategy = new PromedioMinimoStrategy();
