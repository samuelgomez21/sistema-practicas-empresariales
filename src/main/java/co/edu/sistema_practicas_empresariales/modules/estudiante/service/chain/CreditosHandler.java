...
import co.edu.sistema_practicas_empresariales.modules.estudiante.service.strategy.CreditosMinimosStrategy;
...
public class CreditosHandler extends ValidadorAptitudHandler {
    private final RequisitoValidationStrategy strategy = new CreditosMinimosStrategy();
