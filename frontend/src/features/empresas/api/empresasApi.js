...
const db = {
  empresas: [
    ...
    },
    {
      ...
      direccion:         'Cra 15 #93-47, Piso 8',
      municipio:         'Armenia',
      telefono:          '(606) 555-0202',
      sitioWeb:          'www.techco.com.co',
      nombreContacto:    'Carlos Ruiz',
      emailContacto:     'c.ruiz@techco.com',
      correoAcceso:      'c.ruiz@techco.com',
      estado:            'HABILITADA',
      camaraComercio:    { url: 'https://example.com/camara.pdf', fechaVigencia: '2025-05-28', validado: true },
      nit_doc:           { url: 'https://example.com/nit.pdf',    validado: true  },
      cedulaRL:          { url: 'https://example.com/cedula.pdf', validado: true  },
      convenio:          { url: 'https://example.com/convenio.pdf', fechaInicio: '2022-03-15', fechaFin: '2027-03-15', validado: true },
      practicantesActivos: [101, 105],
      // Stats dinámicas
      vacantesActivas: 3,
      estudiantesEnPractica: 2,
    },
    {
      id: 3,
