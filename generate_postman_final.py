...
collection = {
    ...
    "item": [
        ...
        },
        {
            ...
            "item": [
                create_request("Crear Usuario", "POST", "/api/usuarios", {"email": "nuevo@universidad.edu.co", "nombre": "Usuario Prueba", "activo": True, "rol": "DOCENTE_ASESOR"}),
        ...
        },
        {
            ...
            "item": [
                create_request("Crear Vacante", "POST", "/api/vacantes", {"empresaId": 1, "titulo": "Practicante", "descripcion": "Desarrollo", "perfilRequerido": "Estudiante", "requisitos": "Java", "cuposTotales": 2}),
